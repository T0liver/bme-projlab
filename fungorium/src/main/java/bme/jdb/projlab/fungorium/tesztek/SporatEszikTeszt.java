...
public class SporatEszikTeszt {
  ...
  /**
   * A teszt leellnőrzi, hogy az adott Rovar valóban elfogyasztja-e a Bénító spórát. Ezen kívül a
   * spóra elfogyasztása után megvizsgálja a hatást [felgyorsul-e az adott Rovar].
   */
  ...
  /**
   * A teszt leellnőrzi, hogy az adott Rovar valóban elfogyasztja-e a Lassító spórát. Ezen kívül a
   * spóra elfogyasztása után megvizsgálja a hatást [lelassul-e az adott Rovar].
   */
  ...
  /**
   * A teszt leellnőrzi, hogy az adott Rovar valóban elfogyasztja-e a Bénító spórát. Ezen kívül a
   * spóra elfogyasztása után megvizsgálja a hatást [mozgásképtelen lesz-e az adott Rovar].
   */
  ...
  /**
   * A teszt leellnőrzi, hogy az adott Rovar valóban elfogyasztja-e a Csorbító spórát. Ezen kívül a
   * spóra elfogyasztása után megvizsgálja a hatást [képtelen lesz e vágni az adott Rovar].
   */
