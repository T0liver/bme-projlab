...
/**
 * Teszt a rovar elvag egy fonalat funkciora 2 tekton, melyek szomszedosak es koztuk vezet fonal
...
public class RovarVagTeszt {
  public static void RovarVagTeszt() {
    ...
    test.jdbEquals(
        "rovar elvagja a gombafonalat --> megszunik a kapcsolat tekton2-vel",
