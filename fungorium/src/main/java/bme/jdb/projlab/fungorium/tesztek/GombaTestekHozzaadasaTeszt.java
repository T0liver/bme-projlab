...
public class GombaTestekHozzaadasaTeszt {
  ...
  /**
   * A teszt célja, hogy ellenőrizze, hogy a GombaTest objektumok megfelelően létrejönnek és
   * helyezkednek el egy Tekton objektumon, valamint, hogy a már foglalt Tekton objektumra nem lehet
   * új GombaTestet hozzáadni.
   */
  public static void GombaTestekHozzaadasaTeszt() {
    ...
    try {
      gombaTest =
          new GombaTest(5, tekton); // GombaTest létrehozása 5-ös szinttel és a Tekton objektumon
    } catch (Exception e) {
    ...
    try {
      gombaTest2 =
          new GombaTest(
              5, tekton); // Kísérlet új GombaTest létrehozására ugyanazon Tekton objektumon
    } catch (Exception e) {
