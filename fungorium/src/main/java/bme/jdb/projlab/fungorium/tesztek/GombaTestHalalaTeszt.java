...
public class GombaTestHalalaTeszt {
  ...
  /**
   * A teszt ellenőrzi, hogy a GombaTest megfelelően működik-e, amikor egy Tektonon helyezkedik el,
   * spórát szór, majd elpusztul.
   */
  public static void GombaTestHalalaTeszt() {
    ...
    teszt.jdbEquals(
        "tekton1 szomszedja beallitva (tekton2)", tekton.getSzomszed(1).contains(tekton2), true);
    teszt.jdbEquals(
        "tekton2 szomszedja beallitva (tekton1, tekton3)",
        tekton2.getSzomszed(1).contains(tekton),
        true);
    teszt.jdbEquals(
