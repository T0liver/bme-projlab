...
public class SporaTeszt {
  ...
  /**
   * A tesz a spora szorasa szomszedra funkciot teszteli 2 tekton melyek szomsedosak, egyiken
   * gombatest, mely a szomszedjara szor sporat
   */
  public static void SporatSzorTeszt() {
    ...
    test.jdbNotEqual(
        "gombatest sporaszorasa --> csokken a gombatest sporaszama", gombatest.getSporaDarab(), 5);
    test.jdbEquals(
        "gombatest spora szorasa --> csokken az elettartam", gombatest.getElettartam(), 4);

    test.jdbNotEqual(
        "gombatest sporaszorasa --> sporak elhelyezva a szomszedos tektonon",
        tekton2.getSporak(),
        null);
  }

  /**
   * Fejlett gombatest sporat szor szomszed szomszedjara 3 tekton melybol tekton2 szomszedos
   * tekton1-el es tekton2-vel tekton1-en gombatest mely fejlett ezert sporazhat tekton3-ra
   */
  public static void FejlettenSporatSzorTeszt() {
    ...
    test.jdbEquals(
        "tekton1 szomszedja beallitva (tekton2)", tekton1.getSzomszed(1).contains(tekton2), true);
    test.jdbEquals(
        "tekton2 szomszedja beallitva (tekton1, tekton3)",
        tekton2.getSzomszed(1).contains(tekton1),
        true);
    test.jdbEquals(
        "tekton3 szomszedja beallitva (tekton2)", tekton3.getSzomszed(1).contains(tekton2), true);
