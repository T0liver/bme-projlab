...
/**
 * Térkép osztály implementációja
 *
 * <p>Térkép.
 *
 * @author Vid
...
public class Terkep implements Serializable {
  ...
  public Mezo getActiveMezo() {
    return activeMezo;
  }

  public void setActiveMezo(Mezo m) {
    activeMezo = m;
  }
  ...
  private Tekton randomTekton() {
    ...
    switch (num) {
      case 0:
        ret = new EgyetlenFonalTekton();
        break;
      case 1:
        ret = new EletbenTartoTekton();
        break;
      case 2:
        ret = new FelszivoTekton();
        break;
      case 3:
        ret = new TermeketlenTekton();
        break;
      default:
        ret = new Tekton();
        break;
