 ...
 *
 * <p>
 * Ez az osztály felelős azon spórákért, amelyeket ha a rovar megeszik, akkor
 * gyorsabban tud tőle
 * haladni.
 *
 * @author Oliver
...
public class GyorsitoSpora extends Spora {
   ...
   */
  public GyorsitoSpora(int kcal, int db, Gombasz gombasz) {
    super(kcal, db, gombasz);
  }

  /**
   * A spóra kifejti a hatását a rovarra, amikor azt megeszi. A rovar a spóra
   * hatására fel fog
   * gyorsulni.
   *
