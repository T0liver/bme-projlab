 ...
 * 
 * A gombatestből nőnek ki, így tudnak a gombafajok terjedni.
 * A gombafonalak a gombatestből indulva ágaznak egy tektonokon, illetve a tektonok közti réseken átívelve másikokon is.
 * A gombafajok terjedési módja, csak olyan tektonon alakulhat ki, ahol van gombafonal is.
 * Ha egy gombafonal elveszíti a kapcsolatot a gombatesttel, akkor elhal.
 * 
 * @author Oliver
 */
public class GombaFonal {
    ...
    /**
     * Ez a paraméter nélüli publikus konstruktor függvény, ami létrehozza a GombaFonalat egy üres listából.
     */
    public GombaFonal() {
    ...
    /**
     * Ez a paraméteres publikus konstruktor függvény, ami létrehoz egy listát, és belehelyezi a kiinduló tektont.
    ...
    /**
     * Egyik tektonról egy másikra át akarunk jutni gombafonallal, ekkor alakul ki a kapcsolat a két tekton között
     * @param hova melyik tektonra akarunk átjutni.
     * @return visszatér a művelet sikerességével, ha nem szomszédos a tekton, akkor nem sikerül a művelet.
     */
    ...
    /**
     * A gombafonalat elvágták az adott tektonon, ekkor kiveszi az elért tektonjai közül az adott tektont.
