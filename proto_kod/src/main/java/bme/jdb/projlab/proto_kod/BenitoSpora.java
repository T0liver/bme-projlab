 ...
 * 
 * Ez az osztály felelős azon spórákért, amik megbénítják a rovarokat, ha megeszik őket, így a rovarok nem tudnak mozogni a pályán.
 * @author Oliver
 */
public class BenitoSpora extends Spora {
     ...
     * A rovar a spóra hatására meg fog bénulni, nem tud mozogni..
