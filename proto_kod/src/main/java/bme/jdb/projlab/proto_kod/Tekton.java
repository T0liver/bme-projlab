 ...
 * gombatest), ekkor minden rajtuk levő életforma elpusztul,
 * közöttük gombafonál hidalhat át, rajtuk rovarok mozoghatnak, és gombatestek
 * spórát helyezhetnek el, melyek segítségével új gombatest nőhet
 *
 * @author Vid
 */
...
public class Tekton {
     ...
     */
    public void addSzomszed(Tekton tekton) { // legyen inkább csak setter? ez nincs az uml diagramon
        if (!szomszedok.contains(tekton)) // ez redundáns?
     ...
     *                 közvetlen szomszédok; ha 2, akkor szomszédok szomszédai, stb)
     ...
     */
    public boolean /* miért boolean */ addSpora(int mennyiseg /* , + valam faj jelölés */) {
        // sporak.add(spora); valami
        return true;
    }
