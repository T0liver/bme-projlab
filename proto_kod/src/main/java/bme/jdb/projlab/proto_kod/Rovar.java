 ...
 * azokat elvághatják és spóákat esznek, melyek különböző hatásall vannak rájuk
 *
 * @author Vid
 */
public class Rovar {
    ...
    public int eszik(Spora spora) {
        // spora.hatas(this);
        return spora.csokken(5); // jelenleg 5 placeholder érték, hatás még nincs, ahhoz az öröklést várom
    }
}